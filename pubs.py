...
class Publications:
    ...
    def parse_pubs_txt(self):
        self.yaml_data = get_yaml_as_dict(self.pubs_data_file_path)
    ...
    def store_markdown_output_for_pubs(self, output_file_path):
        ...
        W('{:.notice}\n')
        W("This page lists publications that are most reflective of our interests. For a complete list, please see <a href='/people' target='_blank'>our Google Scholar profile</a>.\n")
...
def get_yaml_as_dict(file_path):
    ...
    try:
        ...
        raise ValueError(f"Anvi'o run into some trouble when trying to parse the file at "
